...
export default function Accusoft(props) {
  ...
  const createNew = (title) => {
    fetch('https://cors-anywhere.herokuapp.com/http://134.209.89.163:3001/doc', {
        method: 'POST',
        headers: {
  ...
  function getDocs() {
    fetch('https://cors-anywhere.herokuapp.com/http://134.209.89.163:3001/docs', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  function getDoc(doc) {
    fetch(`https://cors-anywhere.herokuapp.com/http://134.209.89.163:3001/doc/${doc.rowid}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  function getUser() {
    fetch(`https://cors-anywhere.herokuapp.com/http://134.209.89.163:3001/user`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  function deleteAll() {
    fetch(`https://cors-anywhere.herokuapp.com/http://134.209.89.163:3001/delete-all`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      }
